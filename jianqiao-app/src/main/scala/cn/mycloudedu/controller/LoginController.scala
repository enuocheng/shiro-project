...
class LoginController extends BaseController {
  ...
  @ResponseBody def teacherLogin(httpServletRequest: HttpServletRequest, @RequestParam("username") username: String, @RequestParam("password") password: String, @RequestParam(value = "rememberMe", required = false, defaultValue = "false") rememberMe: Boolean): AnyRef = {
