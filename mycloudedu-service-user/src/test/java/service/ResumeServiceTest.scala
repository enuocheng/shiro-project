...
import cn.mycloudedu.user.param.{JobIntentionParam, ResumeEducationParam, ResumeExperienceParam, ResumeSampleParam}
...
class ResumeServiceTest {
  ...
  @Test def getResumeSampleTest: Unit = {
    log.info(JsonBinder.toNormalJson(resumeService.getResumeSample(11)))
  }

  @Test def setResumeSampleTest: Unit = {
    val param = new ResumeSampleParam
    param.setSampleDescription("重新修改下")
    param.setSampleFileUrl("www.jd.com")
    param.setSampleName("我把你给改了")
    resumeService.setResumeSample(11, param)
  }
}
