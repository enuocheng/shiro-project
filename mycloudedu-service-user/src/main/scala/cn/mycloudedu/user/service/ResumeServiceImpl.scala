...
class ResumeServiceImpl extends ResumeService {
  ...
  override def getPositionType(parentId: Int): JavaList[JavaMap[String, Any]] = {
    resumeBiz.getPositionType(parentId)
  }

  override def getResumePositionType(userId: Int): JavaList[JavaMap[String, Any]] = {
    resumeBiz.getResumePositionType(userId)
  }

  override def getJobIntention(userId: Int): JavaMap[String, Any] = {
  ...
  override def getResumeArea(userId: Int): JavaList[JavaMap[String, Any]] = {
  ...
  override def getResumeSample(userId: Int): JavaMap[String, Any] = {
    resumeBiz.getResumeSample(userId)
  }

  override def setResumeSample(userId: Int, param: ResumeSampleParam): Unit = {
    resumeBiz.setResumeSample(userId, param)
  }
}
